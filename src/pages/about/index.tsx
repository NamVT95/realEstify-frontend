...
import image from "@/assets/image/gallery-6.png"
    ...
    <FullLayout>
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            ...
            <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                ...
                <div className="w-full lg:w-6/12">
                    <img className="lg:block hidden w-full" src={image} alt="people discussing on board" />
                    <img className="lg:hidden sm:block hidden w-full" src={image}  alt="people discussing on board" />
                    <img className="sm:hidden block w-full" src={image} alt="people discussing on board" />
                </div>
            </div>
